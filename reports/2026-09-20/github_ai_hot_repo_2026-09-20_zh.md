...
> 数据时间: 2026-09-20 12:44 UTC | 时间窗口: 过去 48 小时
>
...
1. **语言分布**: 上榜项目语言前五: TypeScript(11)、Python(9)、Go(4)、JavaScript(3)、Jupyter Notebook(1)
2. **热门领域**: 大语言模型(14)、AI Agent(14)、MCP 协议(10)、RAG 检索增强(4)、生成式 AI(3)、机器学习(2)
3. **今日最热**: [affaan-m/ECC](https://github.com/affaan-m/ECC) 今日获得 +1.0k stars
4. **大型项目活跃**: ECC、agent-skills、claude-code 等成熟项目持续保持高活跃度
